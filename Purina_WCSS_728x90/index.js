...
(lib.packadult = function() {
	this.initialize(img.packadult);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,205,302);


(lib.packjunior = function() {
	this.initialize(img.packjunior);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,224,328);


(lib.packsterilcat = function() {
	this.initialize(img.packsterilcat);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,206,303);


(lib.Pack_sm_s = function() {
	this.initialize(img.Pack_sm_s);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,207,303);


(lib.Sahd_sm_2 = function() {
	this.initialize(img.Sahd_sm_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,379,72);
...
p.nominalBounds = new cjs.Rectangle(0,0,511,194);


(lib.Tx_4 = function() {
	this.initialize(img.Tx_4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,514,143);
...
(lib.T_4 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(9,12,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(9,12,257,71.5);
...
(lib.T_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-47,-28,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-47,-28,255.5,97);
...
(lib.Shad_sm_2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-45,-80,0.2544,1.6383);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-45,-80,96.4,118);


(lib.Shad_sm_2_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1_copy
	this.instance = new lib.Sahd_sm_2();
	this.instance.parent = this;
	this.instance.setTransform(102.4,-74,0.2544,1.6383,0,0,180);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(6,-74,96.4,118);


(lib.Shad_sm_2_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1_copy
	this.instance = new lib.Sahd_sm_2();
	this.instance.parent = this;
	this.instance.setTransform(109.35,-83,0.278,1.7901,0,0,180);

	this.instance_1 = new lib.Sahd_sm_2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-47,-84,0.278,1.7901);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-47,-84,156.4,129.9);
...
(lib.T4_2 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("A12DaIAAkyMArtAAAIAAEyg");
	mask.setTransform(97.05,21.8);
...
p.nominalBounds = new cjs.Rectangle(-24,12.9,257,30.700000000000003);
...
(lib.T4_1 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A1mHRIAAnoMArNAAAIAAHog");
	mask.setTransform(97.55,46.4957);
...
p.nominalBounds = new cjs.Rectangle(-24,44.1,257,39.4);
...
(lib.T1_3 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A3MIUIAAlyMAuZAAAIAAFyg");
	mask.setTransform(132,53.25);
...
p.nominalBounds = new cjs.Rectangle(4,69.5,255.5,34.5);
...
(lib.T1_2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A3MFbIAAlxMAuZAAAIAAFxg");
	mask.setTransform(132,34.75);
...
p.nominalBounds = new cjs.Rectangle(4,32.5,255.5,37);
...
p.nominalBounds = new cjs.Rectangle(5,7,250,29);


(lib.Pack_sm_2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(94,-7,0.5,0.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(166.5,149,1,1,0,0,0,51.5,94);
	...
	this.instance_2.setTransform(118.3,142.55,1,1,0,0,0,105.3,21.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(11));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(13,-25,210.5,188.8);


(lib.Pack_sm_4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"out":6});
	...
	// Layer_10
	this.instance = new lib.packadult();
	this.instance.parent = this;
	this.instance.setTransform(-75,-10,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(11));

	// Layer_4
	this.instance_1 = new lib.Shad_sm_2_1("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-0.5,142,1,1,0,0,0,51.5,94);
	this.instance_1.alpha = 0;
	...
	this.instance_2 = new lib.Shad_sm();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-41.7,139.55,1,1,0,0,0,105.3,21.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(11));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-147,-26,210.5,186.8);


(lib.Pack_sm_3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{"out":6});
	...
	// Layer_11
	this.instance = new lib.packjunior();
	this.instance.parent = this;
	this.instance.setTransform(5,37,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(11));

	// Layer_4
	this.instance_1 = new lib.Shad_sm_2_2("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(82.5,192,1,1,0,0,0,51.5,94);
	this.instance_1.alpha = 0;
	...
	this.instance_2 = new lib.Shad_sm();
	this.instance_2.parent = this;
	this.instance_2.setTransform(52.3,190.55,1,1,0,0,0,105.3,21.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(11));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-53,0,269.5,211.8);


(lib.Pack_sm_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_9
	this.instance = new lib.packsterilcat();
	this.instance.parent = this;
	this.instance.setTransform(9,-60,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(11));

	// Layer_3
	this.instance_1 = new lib.Shad_sm();
	this.instance_1.parent = this;
	this.instance_1.setTransform(46.3,89.55,1,1,0,0,0,105.3,21.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(11));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-59,-60,210.5,170.8);
...
(lib.Tx_4_1 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.T4_1("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(80,63.5,1,1,0,0,0,80,33.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).to({y:33.5,alpha:1},19,cjs.Ease.quintOut).wait(6).to({startPosition:0},0).to({y:63.5,alpha:0},13,cjs.Ease.quadInOut).wait(5).to({startPosition:0},0).to({_off:true},1).wait(10));

	// T2_1
	this.instance_1 = new lib.T4_2("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(80,63.5,1,1,0,0,0,80,33.5);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:33.5,alpha:1},19,cjs.Ease.quintOut).wait(10).to({startPosition:0},0).to({y:63.5,alpha:0},13,cjs.Ease.quadInOut).wait(3).to({startPosition:0},0).to({_off:true},1).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-24,12.9,257,100.6);
...
p.nominalBounds = new cjs.Rectangle(0,0,259.5,154);
...
(lib._728x90 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(114).call(this.frame_114).wait(59).call(this.frame_173).wait(1));

	// Layer_2
	this.btn_main_link = new lib.click();
	this.btn_main_link.name = "btn_main_link";
	this.btn_main_link.parent = this;
	this.btn_main_link.setTransform(365.4,46.7,2.4272,0.36,0,0,0,0.6,0.8);
	new cjs.ButtonHelper(this.btn_main_link, 0, 1, 2, false, new lib.click(), 3);

	this.timeline.addTween(cjs.Tween.get(this.btn_main_link).wait(174));

	// Tx_4
	this.instance = new lib.Tx_4_1("synched",0,false);
	this.instance.parent = this;
	this.instance.setTransform(551.45,35.6,0.6,0.6,0,0,0,80.4,33.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(23).to({regX:80.1,regY:33.6,x:551.25,y:35.4,mode:"single",startPosition:23},0).wait(30).to({regX:80.2,x:551.3,mode:"synched",loop:false},0).to({_off:true},23).wait(98));

	// Tx_1
	this.instance_1 = new lib.Tx_1_1("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(561.25,41.1,0.7,0.7,0,0,0,132.2,49.2);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(76).to({_off:false},0).wait(29).to({mode:"single",startPosition:29},0).wait(32).to({regY:49.1,y:41,mode:"synched",loop:false},0).to({_off:true},18).wait(19));

	// Pack_sm_3
	this.pack_3 = new lib.Pack_sm_3();
	this.pack_3.name = "pack_3";
	this.pack_3.parent = this;
	this.pack_3.setTransform(375.7,58.7,0.3413,0.3413,0,0,0,108.4,105.6);

	this.timeline.addTween(cjs.Tween.get(this.pack_3).wait(174));

	// Pack_sm_4
	this.pack_4 = new lib.Pack_sm_4();
	this.pack_4.name = "pack_4";
	this.pack_4.parent = this;
	this.pack_4.setTransform(375.7,58.7,0.3413,0.3413,0,0,0,108.4,105.6);

	this.timeline.addTween(cjs.Tween.get(this.pack_4).wait(174));

	// Pack_sm_2
	this.pack_2 = new lib.Pack_sm_2();
	this.pack_2.name = "pack_2";
	this.pack_2.parent = this;
	this.pack_2.setTransform(375.7,58.7,0.3413,0.3413,0,0,0,108.4,105.6);

	this.timeline.addTween(cjs.Tween.get(this.pack_2).wait(174));

	// Pack_sm_steril
	this.pack_1 = new lib.Pack_sm_1();
	this.pack_1.name = "pack_1";
	this.pack_1.parent = this;
	this.pack_1.setTransform(375.7,58.7,0.3413,0.3413,0,0,0,108.4,105.6);

	this.timeline.addTween(cjs.Tween.get(this.pack_1).wait(174));

	// Layer_1
	this.instance_2 = new lib.Logo("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(66.9,46.55,0.4,0.4,0,0,0,111.3,69.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(174));

	// Cat
	this.instance_3 = new lib.Cat("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(224,38,0.37,0.37,0,0,0,165,299.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(174));

	// back
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#017879","#019594"],[0,1],0,-49.4,0,-2).s().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	this.shape.setTransform(364,96.8);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(174));

	// Circle_grad
	this.instance_4 = new lib.Circle_grad("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(361.55,77.95,0.8695,0.8695,0,0,0,125.9,126.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(58).to({startPosition:0},0).to({regX:125.8,regY:126.2,scaleX:1.0977,scaleY:1.0977,y:78.05},18,cjs.Ease.quadInOut).wait(78).to({startPosition:0},0).to({regX:125.9,regY:126.1,scaleX:0.8695,scaleY:0.8695,y:77.95},19,cjs.Ease.quadInOut).wait(1));

	// Layer_4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#009A9B","#35B0B1"],[0,1],-43.5,-16.3,-43.5,31.1).s().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	this.shape_1.setTransform(364,42.225);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(174));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(363.9,-15.5,364.20000000000005,231.6);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/packadult.png", id:"packadult"},
		{src:"images/packjunior.png", id:"packjunior"},
		{src:"images/packsterilcat.png", id:"packsterilcat"},
