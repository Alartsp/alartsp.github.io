...
(lib.Symbol26 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-151,-125,0.5578,0.5578);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-151,-125,251,251);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(69,-247.45,0.6078,0.6078,0,0,0,0.1,0);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,266,0.1879,0.1879,0,0,0,0,-0.2);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(0,247.7);
	...
	this.instance_4.setTransform(0,-6.15,1.4933,1.4933);
	...
	this.instance_6.setTransform(29.05,-118.4,1.4245,1.4245);
	...
	this.instance_7.setTransform(-51.3,90.55,1.4856,1.4856,0,0,0,-0.2,0.1);
	...
	this.instance_8.setTransform(0.15,-80.55,1.4574,1.4574,0,0,0,0.1,-0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(9).to({_off:false},0).to({regX:0,regY:0,scaleX:1.6289,scaleY:1.6289,x:0,y:-80.4,alpha:1,startPosition:19},10,cjs.Ease.cubicOut).wait(51).to({startPosition:70},0).to({alpha:0,startPosition:74},11).to({_off:true},1).wait(143));

	// Layer_9
	this.instance_9 = new lib.Symbol26("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(44.9,98.55,1.289,1.289);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({scaleX:1.4324,scaleY:1.4324,x:66.6,y:80.5},148).to({_off:true},1).wait(76));
...
p.nominalBounds = new cjs.Rectangle(-150,-300,359.9,600);


// stage content:
(lib.proplan_300x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(149,299,174.8,302);
// library properties:
lib.properties = {
