...
(lib.Symbol55 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(72.125,23.075);
...
p.nominalBounds = new cjs.Rectangle(8,17.9,70.9,17.700000000000003);
...
p.nominalBounds = new cjs.Rectangle(-69.5,-35.5,148.4,91.1);
