...
(lib.Symbol55 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(71.825,22.825);
...
p.nominalBounds = new cjs.Rectangle(8,17.7,70.6,17.900000000000002);
...
p.nominalBounds = new cjs.Rectangle(-69.5,-35.5,148.1,91.1);
