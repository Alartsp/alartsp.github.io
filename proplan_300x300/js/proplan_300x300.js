...
(lib.Symbol28 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(0,0,1.0667,1.28);
...
(lib.Symbol26 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-153,-127,0.5622,0.5622);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-153,-127,253,253);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(82,-108.4,0.4738,0.4738);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,129,0.1879,0.1879,0,0,0,0,-0.2);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(0,110.7);
	...
	this.instance_6.setTransform(55.7,-18.55,1.026,1.026);
	...
	this.instance_7.setTransform(-81.5,23.8);
	...
	this.instance_8.setTransform(49.55,-30.7,0.8947,0.8947,0,0,0,0.1,-0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(9).to({_off:false},0).to({regX:0,regY:0,scaleX:1,scaleY:1,x:49.5,y:-30.6,alpha:1,startPosition:19},10,cjs.Ease.cubicOut).wait(51).to({startPosition:70},0).to({alpha:0,startPosition:74},11).to({_off:true},1).wait(143));

	// Layer_9
	this.instance_9 = new lib.Symbol26("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-15,12.5,0.8927,0.8927);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({scaleX:0.992,scaleY:0.992,x:0,y:0},148).to({_off:true},1).wait(76));
...
// stage content:
(lib.proplan_300x300 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(140,140,170,170);
// library properties:
lib.properties = {
