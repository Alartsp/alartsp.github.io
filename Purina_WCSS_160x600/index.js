...
(lib._160x600 = function(mode,startPosition,loop) {
	...
	this.frame_70 = function() {
		this.pack_4.gotoAndPlay(1);
	}
	this.frame_71 = function() {
		this.pack_3.gotoAndPlay(1);
	}
	this.frame_72 = function() {
		this.pack_2.gotoAndPlay(1);
	}
	...
	this.frame_138 = function() {
		this.pack_4.gotoAndPlay("out");
	}
	this.frame_139 = function() {
		this.pack_3.gotoAndPlay("out");
	}
	this.frame_140 = function() {
		this.pack_2.gotoAndPlay("out");
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(70).call(this.frame_70).wait(1).call(this.frame_71).wait(1).call(this.frame_72).wait(42).call(this.frame_114).wait(24).call(this.frame_138).wait(1).call(this.frame_139).wait(1).call(this.frame_140).wait(33).call(this.frame_173).wait(1));

	// Layer_2
	this.btn_main_link = new lib.click();
	this.btn_main_link.name = "btn_main_link";
	this.btn_main_link.parent = this;
	this.btn_main_link.setTransform(80.3,303.3,0.5331,2.4006,0,0,0,0.6,0.8);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(67.45,418.5,0.6,0.6,0,0,0,80.4,33.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(23).to({regX:80.1,regY:33.6,x:67.25,y:418.3,mode:"single",startPosition:23},0).wait(30).to({regX:80.2,x:67.3,mode:"synched",loop:false},0).to({_off:true},23).wait(98));

	// Tx_1
	this.instance_2 = new lib.Tx_1_1("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(80,433.1,0.6,0.6,0,0,0,132.2,49.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(76).to({_off:false},0).wait(29).to({mode:"single",startPosition:29},0).wait(32).to({mode:"synched",loop:false},0).to({_off:true},18).wait(19));

	// Pack_sm_3
	this.pack_3 = new lib.Pack_sm_3();
	this.pack_3.name = "pack_3";
	this.pack_3.parent = this;
	this.pack_3.setTransform(259.75,335.7,0.5333,0.5333,0,0,0,108.4,105.5);
	this.pack_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.pack_3).wait(65).to({_off:false},0).to({regX:108.3,x:105.2,y:335.4},22,cjs.Ease.quartOut).wait(52).to({regX:108.2,x:-65.6,y:335.7},17,cjs.Ease.quadInOut).to({_off:true},1).wait(17));

	// Pack_sm_4
	this.pack_4 = new lib.Pack_sm_4();
	this.pack_4.name = "pack_4";
	this.pack_4.parent = this;
	this.pack_4.setTransform(259.75,335.7,0.5333,0.5333,0,0,0,108.4,105.5);
	this.pack_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.pack_4).wait(64).to({_off:false},0).to({regX:108.3,x:105.2,y:335.4},22,cjs.Ease.quartOut).wait(52).to({regX:108.2,x:-65.6,y:335.7},17,cjs.Ease.quadInOut).to({_off:true},1).wait(18));

	// Pack_sm_2
	this.pack_2 = new lib.Pack_sm_2();
	this.pack_2.name = "pack_2";
	this.pack_2.parent = this;
	this.pack_2.setTransform(259.75,335.7,0.5333,0.5333,0,0,0,108.4,105.5);
	this.pack_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.pack_2).wait(66).to({_off:false},0).to({regX:108.3,x:105.2,y:335.4},22,cjs.Ease.quartOut).wait(52).to({regX:108.2,x:-65.6,y:335.7},17,cjs.Ease.quadInOut).to({_off:true},1).wait(16));

	// Pack_sm_steril
	this.pack_1 = new lib.Pack_sm_1();
	this.pack_1.name = "pack_1";
	this.pack_1.parent = this;
	this.pack_1.setTransform(259.75,335.7,0.5333,0.5333,0,0,0,108.4,105.5);
	this.pack_1._off = true;

	this.pack = new lib.Pack_sm_1();
	this.pack.name = "pack";
	this.pack.parent = this;
	this.pack.setTransform(-65.6,335.7,0.5333,0.5333,0,0,0,108.2,105.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.pack_1}]},67).to({state:[{t:this.pack_1}]},22).to({state:[{t:this.pack_1}]},52).to({state:[{t:this.pack}]},17).to({state:[]},1).wait(15));
	this.timeline.addTween(cjs.Tween.get(this.pack_1).wait(67).to({_off:false},0).to({regX:108.3,x:105.2,y:335.4},22,cjs.Ease.quartOut).wait(52).to({_off:true,regX:108.2,x:-65.6,y:335.7},17,cjs.Ease.quadInOut).wait(16));

	// Cat
	this.instance_3 = new lib.Cat("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(80.55,300.55,0.5333,0.5333,0,0,0,165,300.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(55).to({startPosition:0},0).to({x:-143.45},22,cjs.Ease.quadInOut).to({_off:true},1).wait(72).to({_off:false,x:261.85},0).to({x:80.55},23,cjs.Ease.cubicOut).wait(1));

	// back
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#017879","#019594"],[0,1],0,-164.5,0,-6.4).s().p("AsfXcMAAAgu3IY/AAMAAAAu3g");
	this.shape.setTransform(80,487);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(77.55,332.95,0.8695,0.8695,0,0,0,125.9,126.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(58).to({startPosition:0},0).to({regX:125.8,regY:126.2,scaleX:1.0977,scaleY:1.0977,y:333.05},18,cjs.Ease.quadInOut).wait(78).to({startPosition:0},0).to({regX:125.9,regY:126.1,scaleX:0.8695,scaleY:0.8695,y:332.95},19,cjs.Ease.quadInOut).wait(1));

	// Layer_4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#009A9B","#35B0B1"],[0,1],-10.7,-72.4,-10.7,138.3).s().p("AuDfQMAAAg+fIcHAAMAAAA+fg");
	this.shape_1.setTransform(80,198);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(174));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-144.5,298,539.3,339);
// library properties:
lib.properties = {
