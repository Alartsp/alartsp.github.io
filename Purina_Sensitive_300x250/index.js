...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.btn_main_link.setTransform(150.5,125.8,0.9998,0.9999,0,0,0,0.5,0.8);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(140,192.2,0.73,0.73,0,0,0,80.2,33.6);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(177).to({_off:false},0).wait(23).to({regY:33.7,y:192.25,mode:"single",startPosition:23},0).wait(65).to({regY:33.6,y:192.2,mode:"synched",loop:false},0).wait(29));

	// Tx_3
	this.instance_2 = new lib.Tx_3_1("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(166,207.1,0.6,0.6,0,0,0,132.1,49);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(120).to({_off:false},0).wait(29).to({mode:"single",startPosition:29},0).wait(10).to({regY:49.1,y:207.15,mode:"synched",loop:false},0).to({_off:true},18).wait(117));

	// Tx_2
	this.instance_3 = new lib.Tx_2_1("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(131.85,190.6,1,1,0,0,0,80,33.6);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(52).to({_off:false},0).wait(23).to({mode:"single",startPosition:23},0).wait(29).to({mode:"synched",loop:false},0).to({_off:true},18).wait(172));

	// Tx_1
	this.instance_4 = new lib.Tx_1_1("synched",0,false);
	this.instance_4.parent = this;
	this.instance_4.setTransform(149.95,202.2,1,1,0,0,0,132.1,49.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(29).to({mode:"single",startPosition:29},0).wait(5).to({regY:49.2,x:150,mode:"synched",loop:false},0).to({_off:true},18).wait(242));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(124).to({_off:false},0).to({x:138.75,y:101},22,cjs.Ease.quartOut).wait(119).to({startPosition:0},0).to({regX:140.7,x:-78.9,y:101.1},17,cjs.Ease.quadInOut).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(113).to({startPosition:0},0).to({regX:164.9,x:-82.8},22,cjs.Ease.quadInOut).to({_off:true},1).wait(134).to({_off:false,regX:165.1,x:339.4},0).to({regX:165,x:150.55},23,cjs.Ease.cubicOut).wait(1));

	// back
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#017879","#019594"],[0,1],0,-78.5,0,-3).s().p("A3bLMIAA2XMAu3AAAIAAWXg");
	this.shape.setTransform(149.975,211.4);
	...
	this.instance_7.setTransform(147.45,135.7,0.9056,0.9056,0,0,0,125.9,126.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(127).to({y:117.7},0).to({regX:125.8,scaleX:1.1433,scaleY:1.1433,x:147.4,y:117.75},18,cjs.Ease.quadInOut).wait(129).to({startPosition:0},0).to({regX:125.9,scaleX:0.9056,scaleY:0.9056,x:147.45,y:117.7},19,cjs.Ease.quadInOut).wait(1));

	// Layer_4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#009A9B","#35B0B1"],[0,1],-17.8,-39.8,-17.8,76.1).s().p("A3bRMMAAAgiXMAu3AAAMAAAAiXg");
	this.shape_1.setTransform(149.975,43);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(294));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-34.3,58,455.90000000000003,225.10000000000002);
// library properties:
lib.properties = {
