...
(lib.Tx_2_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(80,81.5,1,1,0,0,0,80,33.5);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:51.5,alpha:1},19,cjs.Ease.quintOut).wait(10).to({startPosition:0},0).wait(1).to({regX:99,regY:30.5,x:99,y:48.9,alpha:0.9856},0).wait(1).to({y:49.95,alpha:0.9501},0).wait(1).to({y:51.8,alpha:0.8899},0).wait(1).to({y:54.4,alpha:0.8023},0).wait(1).to({y:57.85,alpha:0.6879},0).wait(1).to({y:61.85,alpha:0.554},0).wait(1).to({y:66.05,alpha:0.4151},0).wait(1).to({y:69.85,alpha:0.2875},0).wait(1).to({y:73,alpha:0.182},0).wait(1).to({y:75.4,alpha:0.1022},0).wait(1).to({regX:80,regY:33.5,x:80,y:80.1,alpha:0.0469},0).to({_off:true},1).wait(15));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(41,38,116,51);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.btn_main_link.setTransform(150.4,301.9,1.0002,2.3998,0,0,0,0.4,0.8);
...
p.nominalBounds = new cjs.Rectangle(-302,297,941,329.5);
// library properties:
lib.properties = {
