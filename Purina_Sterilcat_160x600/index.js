...
(lib._160x600 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(140).call(this.frame_140).wait(127).call(this.frame_267).wait(26).call(this.frame_293).wait(1));

	// Layer_2
	this.btn_main_link = new lib.click();
	this.btn_main_link.name = "btn_main_link";
	this.btn_main_link.parent = this;
	this.btn_main_link.setTransform(80.1,184.95,0.2962,0.711,0,0,0,0.5,0.8);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(70.4,428.45,0.6,0.6,0,0,0,80.1,33.6);
	this.instance_1._off = true;
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(93.35,420.3,0.57,0.57,0,0,0,132.1,49.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(122).to({_off:false},0).wait(29).to({regX:132.3,regY:49.3,x:93.45,y:420.4,mode:"single",startPosition:29},0).wait(10).to({regX:132.1,regY:49.1,x:93.35,y:420.3,mode:"synched",loop:false},0).to({_off:true},18).wait(115));

	// Tx_2
	this.instance_3 = new lib.Tx_2_1("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(65.8,434.45,0.75,0.75,0,0,0,80,33.6);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(52).to({_off:false},0).wait(23).to({regX:80.2,x:65.95,mode:"single",startPosition:23},0).wait(29).to({mode:"synched",loop:false},0).to({_off:true},18).wait(172));

	// Tx_1
	this.instance_4 = new lib.Tx_1_1("synched",0,false);
	this.instance_4.parent = this;
	this.instance_4.setTransform(80.05,417.15,0.95,0.95,0,0,0,132.1,49.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(29).to({regY:49.1,x:80,y:417.05,mode:"single",startPosition:29},0).wait(5).to({mode:"synched",loop:false},0).to({_off:true},18).wait(242));
	...
	this.timeline.addTween(cjs.Tween.get(this.pack).wait(132).to({_off:false},0).to({regX:108.3,x:105.2,y:335.4},22,cjs.Ease.quartOut).wait(113).to({regX:108.2,x:-65.6,y:335.7},17,cjs.Ease.quadInOut).wait(10));

	// Pack_big
	this.instance_5 = new lib.Pack_big("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(224,317.1,0.5333,0.5333,0,0,0,140.8,126.8);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(124).to({_off:false},0).to({regX:140.7,regY:126.9,x:69.2,y:317},22,cjs.Ease.quartOut).wait(119).to({startPosition:0},0).to({regY:126.8,x:-101.3,y:317.1},17,cjs.Ease.quadInOut).wait(12));

	// Cat
	this.instance_6 = new lib.Cat("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(80.55,300.55,0.5333,0.5333,0,0,0,165,300.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(113).to({startPosition:0},0).to({x:-143.45},22,cjs.Ease.quadInOut).to({_off:true},1).wait(134).to({_off:false,x:261.85},0).to({x:80.55},23,cjs.Ease.cubicOut).wait(1));

	// back
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#017879","#019594"],[0,1],0,-164.5,0,-6.4).s().p("AuDXcMAAAgu3IcHAAMAAAAu3g");
	this.shape.setTransform(80,486.55);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(77.55,332.95,0.8695,0.8695,0,0,0,125.9,126.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(127).to({startPosition:0},0).to({regX:125.8,regY:126.2,scaleX:1.0977,scaleY:1.0977,y:333.05},18,cjs.Ease.quadInOut).wait(129).to({startPosition:0},0).to({regX:125.9,regY:126.1,scaleX:0.8695,scaleY:0.8695,y:332.95},19,cjs.Ease.quadInOut).wait(1));

	// Layer_4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#009A9B","#35B0B1"],[0,1],-10.7,-72.4,-10.7,138.3).s().p("AuDfQMAAAg+fIcHAAMAAAA+fg");
	this.shape_1.setTransform(80,191);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(294));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-144.5,291,539.3,345.6);
// library properties:
lib.properties = {
