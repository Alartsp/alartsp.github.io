...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.btn_main_link.setTransform(150.35,126.7,0.9996,1.0002,0,0,0,0.5,0.7);
	...
	// Logo
	this.instance = new lib.Logocopy("synched",0);
	this.instance.parent = this;
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(140.05,200.2,0.7,0.7,0,0,0,80.2,33.5);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(177).to({_off:false},0).wait(23).to({regY:33.6,mode:"single",startPosition:23},0).wait(65).to({mode:"synched",loop:false},0).wait(29));

	// Tx_3
	this.instance_2 = new lib.Tx_3_1("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(163.85,206.65,0.7,0.7,0,0,0,132.1,49.1);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(139.35,195.2,0.75,0.75,0,0,0,80,33.6);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(51).to({_off:false},0).wait(23).to({y:195.25,mode:"single",startPosition:23},0).wait(29).to({mode:"synched",loop:false},0).to({_off:true},18).wait(173));

	// Tx_1
	this.instance_4 = new lib.Tx_1_1("synched",0,false);
	this.instance_4.parent = this;
	this.instance_4.setTransform(149.95,202.2,1.1,1.1,0,0,0,132.1,49.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(29).to({regX:132.2,x:150,mode:"single",startPosition:29},0).wait(5).to({regX:132.1,x:149.95,mode:"synched",loop:false},0).to({_off:true},18).wait(242));

	// Pack_sm
	this.pack = new lib.Pack_sm();
	this.pack.name = "pack";
	this.pack.parent = this;
	this.pack.setTransform(337.2,120.55,0.5555,0.5555,0,0,0,108.4,105.6);
	this.pack._off = true;

	this.timeline.addTween(cjs.Tween.get(this.pack).wait(132).to({_off:false},0).to({regX:108.3,regY:105.5,x:176.2,y:120.25},22,cjs.Ease.quartOut).wait(113).to({regX:108.2,regY:105.6,x:-51.7,y:120.55},17,cjs.Ease.quadInOut).wait(10));

	// Pack_big
	this.instance_5 = new lib.Pack_big("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(299.95,101.1,0.5555,0.5555,0,0,0,140.8,126.8);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(124).to({_off:false},0).to({x:138.75,y:101},22,cjs.Ease.quartOut).wait(119).to({startPosition:0},0).to({regX:140.7,x:-88.9,y:101.1},17,cjs.Ease.quadInOut).wait(12));

	// Cat
	this.instance_6 = new lib.Cat("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(150.55,83.9,0.5555,0.5555,0,0,0,165,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(113).to({startPosition:0},0).to({regX:164.9,x:-142.8},22,cjs.Ease.quadInOut).to({_off:true},1).wait(134).to({_off:false,regX:165.1,x:339.4},0).to({regX:165,x:150.55},23,cjs.Ease.cubicOut).wait(1));

	// back
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#017879","#019594"],[0,1],0,-78.5,0,-3).s().p("A3bLMIAA2XMAu3AAAIAAWXg");
	this.shape.setTransform(150.275,211.4);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(147.45,117.7,0.9056,0.9056,0,0,0,125.9,126.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(127).to({startPosition:0},0).to({regX:125.8,scaleX:1.1433,scaleY:1.1433,x:147.4,y:117.75},18,cjs.Ease.quadInOut).wait(129).to({startPosition:0},0).to({regX:125.9,scaleX:0.9056,scaleY:0.9056,x:147.45,y:117.7},19,cjs.Ease.quadInOut).wait(1));

	// Layer_4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#009A9B","#35B0B1"],[0,1],-17.8,-39.8,-17.8,76.1).s().p("A3bRMMAAAgiXMAu3AAAMAAAAiXg");
	this.shape_1.setTransform(150.275,72.9);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(294));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-77.1,87.9,554.9,195.20000000000002);
// library properties:
lib.properties = {
