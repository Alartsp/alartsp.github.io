...
p.nominalBounds = new cjs.Rectangle(0,0,267,91);
...
p.nominalBounds = new cjs.Rectangle(0,0,528,196);
...
(lib.T1_3 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A3MIKIAAlxMAuZAAAIAAFxg");
	mask.setTransform(132,52.25);
...
p.nominalBounds = new cjs.Rectangle(0,67.5,264,30.5);
...
p.nominalBounds = new cjs.Rectangle(0,32.5,264,37);
...
(lib.T1_1 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A3MC5IAAlxMAuZAAAIAAFxg");
	mask.setTransform(134,13);
...
p.nominalBounds = new cjs.Rectangle(0,0,264,31.5);
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,0,1.67,1.67);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(0,0,445.9,152), null);
...
(lib.Cat = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-5,162);
...
(lib.Tx_2_1 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(86.95,34,0.65,0.65,0,0,0,222.6,75.9);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(8).to({_off:false},0).wait(1).to({regX:222.9,regY:76,scaleX:0.6472,scaleY:0.6472,x:87.15,y:34.1,alpha:0.0636},0).wait(1).to({scaleX:0.6444,scaleY:0.6444,alpha:0.1273},0).wait(1).to({scaleX:0.6417,scaleY:0.6417,x:87.2,y:34.05,alpha:0.1909},0).wait(1).to({scaleX:0.6389,scaleY:0.6389,x:87.15,alpha:0.2545},0).wait(1).to({scaleX:0.6361,scaleY:0.6361,y:34.1,alpha:0.3182},0).wait(1).to({scaleX:0.6333,scaleY:0.6333,alpha:0.3818},0).wait(1).to({scaleX:0.6306,scaleY:0.6306,y:34.05,alpha:0.4455},0).wait(1).to({scaleX:0.6278,scaleY:0.6278,alpha:0.5091},0).wait(1).to({scaleX:0.625,scaleY:0.625,alpha:0.5727},0).wait(1).to({scaleX:0.6222,scaleY:0.6222,y:34.1,alpha:0.6364},0).wait(1).to({scaleX:0.6194,scaleY:0.6194,alpha:0.7},0).wait(1).to({scaleX:0.6167,scaleY:0.6167,y:34.05},0).wait(1).to({scaleX:0.6139,scaleY:0.6139},0).wait(1).to({scaleX:0.6111,scaleY:0.6111},0).wait(1).to({scaleX:0.6083,scaleY:0.6083,y:34.1},0).wait(1).to({scaleX:0.6056,scaleY:0.6056,y:34.05},0).wait(1).to({scaleX:0.6028,scaleY:0.6028},0).wait(1).to({scaleX:0.6,scaleY:0.6},0).wait(1).to({alpha:0.6417},0).wait(1).to({alpha:0.5833},0).wait(1).to({alpha:0.525},0).wait(1).to({alpha:0.4667},0).wait(1).to({alpha:0.4083},0).wait(1).to({alpha:0.35},0).wait(1).to({alpha:0.2917},0).wait(1).to({alpha:0.2333},0).wait(1).to({alpha:0.175},0).wait(1).to({alpha:0.1167},0).wait(1).to({alpha:0.0583},0).wait(1).to({alpha:0},0).to({_off:true},1).wait(20));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-57.7,-15.3,289.8,112.3);
...
(lib.Tx_1_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(132.05,79.05,1.3199,1.3199,0,0,0,132,49.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).to({regX:131.9,regY:49,scaleX:1.32,scaleY:1.32,x:131.95,y:43.1,alpha:1},19,cjs.Ease.quintOut).wait(9).to({regX:132,scaleX:1.3199,scaleY:1.3199,x:132.05,y:46.05},0).to({regY:49.1,y:99.05,alpha:0},16,cjs.Ease.quadInOut).to({_off:true},1).wait(102));

	// T1_2
	this.instance_1 = new lib.T1_2("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(132,79.05,1.32,1.32,0,0,0,132,49.1);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({_off:false},0).to({regX:131.9,regY:49,x:131.9,y:48.05,alpha:1},19,cjs.Ease.quintOut).wait(12).to({regX:132,x:132,y:49},0).to({regY:49.1,y:99.05,alpha:0},16,cjs.Ease.quadInOut).to({_off:true},1).wait(101));

	// T1_1
	this.instance_2 = new lib.T1_1("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(132.05,79.05,1.3199,1.3199,0,0,0,132,49.1);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:131.9,regY:49,scaleX:1.32,scaleY:1.32,x:131.9,y:49.05,alpha:1},19,cjs.Ease.quintOut).wait(15).to({regX:132,scaleX:1.3199,scaleY:1.3199,x:132.05},0).to({regY:49.1,y:99.05,alpha:0},16,cjs.Ease.quadInOut).to({_off:true},1).wait(100));

	// Layer_2
	this.instance_3 = new lib.Symbol3();
	this.instance_3.parent = this;
	this.instance_3.setTransform(149.95,48,1.2,1,0,0,0,222.9,76);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(8).to({_off:false},0).wait(1).to({alpha:0.0636},0).wait(1).to({alpha:0.1273},0).wait(1).to({alpha:0.1909},0).wait(1).to({alpha:0.2545},0).wait(1).to({alpha:0.3182},0).wait(1).to({alpha:0.3818},0).wait(1).to({alpha:0.4455},0).wait(1).to({alpha:0.5091},0).wait(1).to({alpha:0.5727},0).wait(1).to({alpha:0.6364},0).wait(1).to({alpha:0.7},0).wait(15).to({alpha:0.6417},0).wait(1).to({alpha:0.5833},0).wait(1).to({alpha:0.525},0).wait(1).to({alpha:0.4667},0).wait(1).to({alpha:0.4083},0).wait(1).to({alpha:0.35},0).wait(1).to({alpha:0.2917},0).wait(1).to({alpha:0.2333},0).wait(1).to({alpha:0.175},0).wait(1).to({alpha:0.1167},0).wait(1).to({alpha:0.0583},0).wait(1).to({alpha:0},0).to({_off:true},1).wait(105));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-117.5,-28,535.1,191.6);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.pack.setTransform(34.8,17.2,0.5333,0.5333,0,0,0,108.3,105.5);

	this.instance = new lib.Pack_big("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-10,-6.15,0.5333,0.5333,0,0,0,140.7,126.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.pack}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(-88.7,-73.8,177.5,147.7), null);
...
(lib._728x90 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(91).call(this.frame_91).wait(40).call(this.frame_131).wait(69).call(this.frame_200).wait(1));

	// Layer_2
	this.btn_main_link = new lib.click();
	this.btn_main_link.name = "btn_main_link";
	this.btn_main_link.parent = this;
	this.btn_main_link.setTransform(365.1,45.25,2.4262,0.36,0,0,0,0.5,0.8);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(583.4,45.35,0.95,0.95,0,0,0,80,33.6);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(105).to({_off:false},0).wait(23).to({mode:"single",startPosition:23},0).wait(55).to({regX:80.1,x:583.5,mode:"synched",loop:false},0).wait(18));

	// Tx_1
	this.instance_2 = new lib.Tx_1_1("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(584,46.05,0.59,0.59,0,0,0,132.1,49.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({regX:132.2,x:584.05,mode:"single",startPosition:29},0).wait(31).to({mode:"synched",loop:false},0).to({_off:true},18).wait(123));

	// Pack_sm
	this.instance_3 = new lib.Symbol2();
	this.instance_3.parent = this;
	this.instance_3.setTransform(366.6,46.15,0.55,0.55,0,0,0,0.2,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(201));

	// Cat
	this.instance_4 = new lib.Cat("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(190.55,32.55,0.35,0.35,0,0,0,165,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(201));

	// back
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#E84F7E","#EA739E"],[0,1],-0.2,-141.4,-0.2,-5.4).s().p("A6XUKMAAAgoTMA0uAAAMAAAAoTg");
	this.shape.setTransform(364.0055,71.7874,2.1572,0.155);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(201));

	// Circle_grad
	this.instance_5 = new lib.Circle_grad("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(361.55,77.95,0.8695,0.8695,0,0,0,125.9,126.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(201));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(364,13.3,388.4,174.1);
// library properties:
lib.properties = {
