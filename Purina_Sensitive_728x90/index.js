...
p.nominalBounds = new cjs.Rectangle(0,0,331,373);


(lib.Pack_big_s = function() {
	this.initialize(img.Pack_big_s);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,406,518);
...
p.nominalBounds = new cjs.Rectangle(0,0,460,53);
...
p.nominalBounds = new cjs.Rectangle(0,0,537,203);
...
(lib.T_4 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-3,5,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-3,5,268.5,101.5);
...
(lib.T_2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(41,20,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(41,20,116,21);
...
(lib.T_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-33,-17,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-33,-17,230,26.5);
...
(lib.Cat = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-18,120);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-18,0,432.3,600);
...
(lib.T4_4 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("A1mIwIAAkPMArNAAAIAAEPg");
	mask.setTransform(98.65,55.9766);
...
p.nominalBounds = new cjs.Rectangle(-36,84.9,268.5,21.599999999999994);
...
(lib.T4_3 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A1mGlIAAj7MArNAAAIAAD7g");
	mask.setTransform(98.65,42.0631);
...
p.nominalBounds = new cjs.Rectangle(-36,59.1,268.5,24.999999999999993);
...
(lib.T4_2 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A12CZIAAkxMArtAAAIAAExg");
	mask.setTransform(97.0528,15.2654);
...
p.nominalBounds = new cjs.Rectangle(-36,5,268.5,25.6);
...
(lib.T4_1 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A1mEjIAAkJMArNAAAIAAEJg");
	mask.setTransform(97.55,29.1078);
...
p.nominalBounds = new cjs.Rectangle(-36,31.8,268.5,26.400000000000002);
...
(lib.T1_1 = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AzhC+IAAl7MAnDAAAIAAF7g");
	mask.setTransform(130,32);
...
p.nominalBounds = new cjs.Rectangle(18,18,230,26.5);
...
(lib.Pack_big = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(62,-14,0.5,0.5);
	...
	this.instance_1.setTransform(159.3,234.3,1,1,0,0,0,142.3,24.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-14,301.5,272.5);
...
(lib.Tx_4_1 = function(mode,startPosition,loop) {
	...
	// Layer_2_copy
	this.instance = new lib.T4_4("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(80,63.5,1,1,0,0,0,80,33.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(5).to({_off:false},0).to({y:33.5,alpha:1},19,cjs.Ease.quintOut).wait(1).to({startPosition:0},0).to({y:63.5,alpha:0},12,cjs.Ease.quadInOut).wait(14).to({startPosition:0},0).to({_off:true},1).wait(4));

	// Layer_2
	this.instance_1 = new lib.T4_3("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(80,63.5,1,1,0,0,0,80,33.5);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},0).to({y:33.5,alpha:1},19,cjs.Ease.quintOut).wait(3).to({startPosition:0},0).to({y:63.5,alpha:0},12,cjs.Ease.quadInOut).wait(13).to({startPosition:0},0).to({_off:true},1).wait(4));

	// Layer_1
	this.instance_2 = new lib.T4_1("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(80,63.5,1,1,0,0,0,80,33.5);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(2).to({_off:false},0).to({y:33.5,alpha:1},19,cjs.Ease.quintOut).wait(6).to({startPosition:0},0).to({y:63.5,alpha:0},13,cjs.Ease.quadInOut).wait(11).to({startPosition:0},0).to({_off:true},1).wait(4));

	// T2_1
	this.instance_3 = new lib.T4_2("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(80,63.5,1,1,0,0,0,80,33.5);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:33.5,alpha:1},19,cjs.Ease.quintOut).wait(10).to({startPosition:0},0).to({y:63.5,alpha:0},13,cjs.Ease.quadInOut).wait(9).to({startPosition:0},0).to({_off:true},1).wait(4));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-36,5,268.5,131.5);
...
(lib.Tx_2_1 = function(mode,startPosition,loop) {
	...
	// T2_1
	this.instance = new lib.T2_2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(67.1,81.5,1.7099,1.7099,0,0,0,80,33.5);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:58.45,alpha:1},19,cjs.Ease.quintOut).wait(10).to({startPosition:0},0).wait(1).to({regX:99,regY:30.5,x:99.65,y:53.6,alpha:0.9856},0).wait(1).to({y:54.45,alpha:0.9501},0).wait(1).to({y:55.8,alpha:0.8899},0).wait(1).to({y:57.85,alpha:0.8023},0).wait(1).to({y:60.45,alpha:0.6879},0).wait(1).to({y:63.55,alpha:0.554},0).wait(1).to({y:66.75,alpha:0.4151},0).wait(1).to({y:69.7,alpha:0.2875},0).wait(1).to({y:72.15,alpha:0.182},0).wait(1).to({y:74,alpha:0.1022},0).wait(1).to({regX:80,regY:33.5,x:67.15,y:80.35,alpha:0.0469},0).to({_off:true},1).wait(15));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0.3,35.3,198.5,59);
...
(lib.Tx_1_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(132,98,1,1,0,0,0,132,49);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:68,alpha:1},19,cjs.Ease.quintOut).wait(15).to({startPosition:0},0).wait(1).to({regX:133,regY:31.3,x:133,y:50.8,alpha:0.9898},0).wait(1).to({y:51.95,alpha:0.9663},0).wait(1).to({y:53.9,alpha:0.9274},0).wait(1).to({y:56.7,alpha:0.8714},0).wait(1).to({y:60.4,alpha:0.7971},0).wait(1).to({y:65,alpha:0.7053},0).wait(1).to({y:70.3,alpha:0.5996},0).wait(1).to({y:75.9,alpha:0.4872},0).wait(1).to({y:81.4,alpha:0.3771},0).wait(1).to({y:86.4,alpha:0.2773},0).wait(1).to({y:90.65,alpha:0.1927},0).wait(1).to({regX:132,regY:49,x:132,y:111.75,alpha:0.125},0).to({_off:true},1).wait(104));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,248,113.5);
...
(lib._728x90 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(293).call(this.frame_293).wait(1));

	// Layer_2
	this.btn_main_link = new lib.click();
	this.btn_main_link.name = "btn_main_link";
	this.btn_main_link.parent = this;
	this.btn_main_link.setTransform(365.15,45.25,2.427,0.36,0,0,0,0.5,1);
	...
	// Tx_4
	this.instance = new lib.Tx_4_1("synched",0,false);
	this.instance.parent = this;
	this.instance.setTransform(547,29.2,0.73,0.73,0,0,0,80.2,33.6);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(177).to({_off:false},0).wait(23).to({regY:33.7,y:29.25,mode:"single",startPosition:23},0).wait(65).to({regY:33.6,y:29.2,mode:"synched",loop:false},0).wait(29));

	// Tx_3
	this.instance_1 = new lib.Tx_3_1("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(583,47.95,0.73,0.73,0,0,0,132.2,49.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(122).to({_off:false},0).wait(29).to({regY:49.2,y:48,mode:"single",startPosition:29},0).wait(10).to({regY:49.1,y:47.95,mode:"synched",loop:false},0).to({_off:true},18).wait(115));

	// Tx_2
	this.instance_2 = new lib.Tx_2_1("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(550.45,31.5,0.7,0.7,0,0,0,80.1,33.6);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(52).to({_off:false},0).wait(23).to({regX:80.2,regY:33.5,x:550.55,y:31.45,mode:"single",startPosition:23},0).wait(29).to({regX:80.1,regY:33.6,x:550.45,y:31.5,mode:"synched",loop:false},0).to({_off:true},18).wait(172));

	// Tx_1
	this.instance_3 = new lib.Tx_1_1("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(563.95,41.2,1,1,0,0,0,132.1,49.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(29).to({mode:"single",startPosition:29},0).wait(5).to({regY:49.2,y:41.3,mode:"synched",loop:false},0).to({_off:true},18).wait(242));

	// Layer_1
	this.instance_4 = new lib.Logocopy("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(66.9,46.55,0.4,0.4,0,0,0,111.3,69.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(294));

	// Pack_big
	this.instance_5 = new lib.Pack_big("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(357.6,47.95,0.35,0.35,0,0,0,140.8,126.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(294));

	// Cat
	this.instance_6 = new lib.Cat("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(208.5,39.55,0.3,0.3,0,0,0,165,300.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(294));

	// back
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#017879","#019594"],[0,1],0,-49.3,0,-1.9).s().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	this.shape.setTransform(364,96.55);
	...
	this.instance_7.setTransform(361.55,77.95,0.8695,0.8695,0,0,0,125.9,126.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(127).to({startPosition:0},0).to({regX:125.8,regY:126.2,scaleX:1.0977,scaleY:1.0977,y:78.05},18,cjs.Ease.quadInOut).wait(129).to({startPosition:0},0).to({regX:125.9,regY:126.1,scaleX:0.8695,scaleY:0.8695,y:77.95},19,cjs.Ease.quadInOut).wait(1));

	// Layer_4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#009A9B","#35B0B1"],[0,1],-43.5,-16.3,-43.5,31.1).s().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	this.shape_1.setTransform(364,44.975);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(294));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(363.9,-15.5,364.1,231.6);
// library properties:
lib.properties = {
