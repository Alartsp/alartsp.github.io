...
p.nominalBounds = new cjs.Rectangle(0,0,523,198);// helper functions:
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.pack.setTransform(30.4,17.9,0.5333,0.5333,0,0,0,108.3,105.5);

	this.instance = new lib.Pack_big("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-5.6,-0.5,0.5333,0.5333,0,0,0,140.7,126.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.pack}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol1, new cjs.Rectangle(-84.3,-74.5,168.7,149.1), null);
...
(lib._728x90 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(140).call(this.frame_140).wait(153).call(this.frame_293).wait(1));
	...
	this.instance.parent = this;
	this.instance.setTransform(66.9,46.55,0.4,0.4,0,0,0,111.3,69.2);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(558.4,35.45,0.6,0.6,0,0,0,80.1,33.6);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(179).to({_off:false},0).wait(23).to({mode:"single",startPosition:23},0).wait(65).to({mode:"synched",loop:false},0).wait(27));

	// Tx_3
	this.instance_2 = new lib.Tx_3_1("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(580.95,48.3,0.57,0.57,0,0,0,132.1,49.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(122).to({_off:false},0).wait(29).to({regX:132.3,regY:49.3,x:581.05,y:48.4,mode:"single",startPosition:29},0).wait(10).to({regX:132.1,regY:49.1,x:580.95,y:48.3,mode:"synched",loop:false},0).to({_off:true},18).wait(115));

	// Tx_2
	this.instance_3 = new lib.Tx_2_1("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(551.95,36.1,0.75,0.75,0,0,0,80,33.6);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(52).to({_off:false},0).wait(23).to({regX:80.2,x:552.1,mode:"single",startPosition:23},0).wait(29).to({mode:"synched",loop:false},0).to({_off:true},18).wait(172));

	// Tx_1
	this.instance_4 = new lib.Tx_1_1("synched",0,false);
	this.instance_4.parent = this;
	this.instance_4.setTransform(566,45.05,0.95,0.95,0,0,0,132.1,49.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(29).to({regY:49.1,y:44.95,mode:"single",startPosition:29},0).wait(5).to({mode:"synched",loop:false},0).to({_off:true},18).wait(242));

	// Pack_sm
	this.instance_5 = new lib.Symbol1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(358.75,46.45,0.62,0.62,0,0,0,0.1,0.1);
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(224,38,0.37,0.37,0,0,0,165,299.8);
