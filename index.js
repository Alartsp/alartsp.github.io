...
p.nominalBounds = new cjs.Rectangle(0,0,296,331);
...
p.nominalBounds = new cjs.Rectangle(0,0,528,43);


(lib.Tx_2 = function() {
	this.initialize(img.Tx_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,484,187);


(lib.Tx_4 = function() {
	this.initialize(img.Tx_4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,399,198);
...
(lib.T_4 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(31,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(31,0,199.5,99);
...
(lib.T_2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-22,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-22,0,242,93.5);
...
(lib.T_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-51,5,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-51,5,264,21.5);
...
(lib.Cat = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(13,147);
...
p.nominalBounds = new cjs.Rectangle(-2,72,199.5,27);
...
p.nominalBounds = new cjs.Rectangle(-2,0,199.5,27.5);
...
p.nominalBounds = new cjs.Rectangle(-2,30.6,199.5,38.6);
...
p.nominalBounds = new cjs.Rectangle(-22,65,242,28.5);
...
p.nominalBounds = new cjs.Rectangle(-22,0,242,27.5);
...
p.nominalBounds = new cjs.Rectangle(-22,27.6,242,38.6);
...
p.nominalBounds = new cjs.Rectangle(0,40,264,21.5);
...
(lib.Pack_big = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(35,-13,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-7,-13,288.5,271.5);
...
p.nominalBounds = new cjs.Rectangle(-2,0,199.5,129);
...
p.nominalBounds = new cjs.Rectangle(-22,0,242,123.5);
...
(lib.Tx_1_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:49,alpha:1},19,cjs.Ease.quintOut).wait(3).to({startPosition:0},0).to({_off:true},1).wait(6).to({_off:false},0).wait(5).to({startPosition:0},0).wait(1).to({regY:50.8,y:51.3,alpha:0.9898},0).wait(1).to({y:52.45,alpha:0.9663},0).wait(1).to({y:54.4,alpha:0.9274},0).wait(1).to({y:57.2,alpha:0.8714},0).wait(1).to({y:60.9,alpha:0.7971},0).wait(1).to({y:65.5,alpha:0.7053},0).wait(1).to({y:70.8,alpha:0.5996},0).wait(1).to({y:76.4,alpha:0.4872},0).wait(1).to({y:81.9,alpha:0.3771},0).wait(1).to({y:86.9,alpha:0.2773},0).wait(1).to({y:91.15,alpha:0.1927},0).wait(1).to({regY:49,y:92.75,alpha:0.125},0).to({_off:true},1).wait(104));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,264,111.5);


// stage content:
(lib.Purina_Adult_300x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(140).call(this.frame_140).wait(19).call(this.frame_159).wait(53).call(this.frame_212).wait(26).call(this.frame_238).wait(1));

	// Layer_2
	this.btn_main_link = new lib.click();
	this.btn_main_link.name = "btn_main_link";
	this.btn_main_link.parent = this;
	this.btn_main_link.setTransform(150.3,301.9,0.9999,2.3999,0,0,0,0.3,0.8);
	new cjs.ButtonHelper(this.btn_main_link, 0, 1, 2, false, new lib.click(), 3);

	this.timeline.addTween(cjs.Tween.get(this.btn_main_link).wait(239));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(120).to({_off:false},0).wait(23).to({mode:"single",startPosition:23},0).wait(66).to({mode:"synched",loop:false},0).to({_off:true},29).wait(1));

	// Tx_2
	this.instance_2 = new lib.Tx_2_1("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(131,501.5,1,1,0,0,0,80,33.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(23).to({mode:"single",startPosition:23},0).wait(29).to({mode:"synched",loop:false},0).to({_off:true},69).wait(118));

	// Tx_1
	this.instance_3 = new lib.Tx_1_1("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(150,514,1,1,0,0,0,132,49);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(69).to({_off:false},0).wait(23).to({mode:"single",startPosition:29},0).wait(11).to({mode:"synched",loop:false},0).to({_off:true},18).wait(118));
	...
	this.timeline.addTween(cjs.Tween.get(this.pack).wait(132).to({_off:false},0).to({x:197.3,y:366.5},22,cjs.Ease.quartOut).wait(58).to({x:-122.95,y:367},17,cjs.Ease.quadInOut).wait(10));

	// Pack_big
	this.instance_4 = new lib.Pack_big("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(420.05,332.05,1,1,0,0,0,140.8,126.8);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(124).to({_off:false},0).to({x:129.8,y:331.8},22,cjs.Ease.quartOut).wait(64).to({startPosition:0},0).to({x:-189.95,y:332.05},17,cjs.Ease.quadInOut).wait(12));

	// Cat
	this.instance_5 = new lib.Cat("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(151,301,1,1,0,0,0,165,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(113).to({startPosition:0},0).to({x:-269},22,cjs.Ease.quadInOut).to({_off:true},1).wait(79).to({_off:false,x:491},0).to({x:151},23,cjs.Ease.cubicOut).wait(1));

	// back
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#017879","#019594"],[0,1],0,-125.7,0,-4.8).s().p("A3bR7MAAAgj1MAu3AAAMAAAAj1g");
	this.shape.setTransform(151.25,483.175);
	...
	this.instance_6.setTransform(145.4,361.8,1.6303,1.6303,0,0,0,125.9,126.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(127).to({startPosition:0},0).to({regX:125.8,regY:126.2,scaleX:2.0582,scaleY:2.0582,x:145.35,y:361.95},18,cjs.Ease.quadInOut).wait(74).to({startPosition:0},0).to({regX:125.9,regY:126.1,scaleX:1.6303,scaleY:1.6303,x:145.4,y:361.8},19,cjs.Ease.quadInOut).wait(1));

	// Layer_4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#009A9B","#35B0B1"],[0,1],-20.1,-71.6,-20.1,137).s().p("A6We8MAAAg93MA0uAAAMAAAA93g");
	this.shape_1.setTransform(150,195);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(239));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-271,297,906,323.9);
// library properties:
lib.properties = {
