...
(lib.Symbol26 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-152,-130,0.5711,0.5711);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-152,-130,257,257);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(82,-83.4,0.4738,0.4738);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(0,87.7);
	...
	this.instance_6.setTransform(57.5,2.55);
	...
	this.instance_8.setTransform(49.55,-12.7,0.8947,0.8947,0,0,0,0.1,-0.1);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(9).to({_off:false},0).to({regX:0,regY:0,scaleX:1,scaleY:1,x:49.5,y:-12.6,alpha:1,startPosition:19},10,cjs.Ease.cubicOut).wait(51).to({startPosition:70},0).to({alpha:0,startPosition:74},11).to({_off:true},1).wait(143));
...
p.nominalBounds = new cjs.Rectangle(-150.8,-128.9,300.8,255);


// stage content:
(lib.proplan_300x250 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
